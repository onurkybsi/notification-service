...
internal class JooqImplIntegrationTest : PostgreSQLContainerRunner() {
        ...
        runTest {
            ...
            actual.shouldBeRight(
                listOf(
                    ...
                    TestData.notificationTemplate.copy(id = 2, type = NotificationType.PASSWORD_RESET),
                ),
            )
        }

    @Test
    fun `should return notification templates by notification channel`() =
        runTest {
            // given
            insert(TestData.notificationTemplate)
    ...
    @Test
    fun `should return notification templates by notification language`() =
        runTest {
            // given
            insert(TestData.notificationTemplate)
